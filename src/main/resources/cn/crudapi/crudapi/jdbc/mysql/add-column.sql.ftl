...
<#elseif columnEntity.dataType == "INT">
  `${columnEntity.name}` INT<#if columnEntity.defaultValue??> DEFAULT ${columnEntity.defaultValue}</#if><#if columnEntity.nullable != true> NOT NULL</#if><#if columnEntity.autoIncrement == true> AUTO_INCREMENT</#if><#if columnEntity.indexType?? && columnEntity.indexType == "PRIMARY"> PRIMARY KEY</#if> COMMENT '${columnEntity.caption}'
<#elseif columnEntity.dataType == "BIGINT">
  `${columnEntity.name}` BIGINT<#if columnEntity.defaultValue??> DEFAULT ${columnEntity.defaultValue}</#if><#if columnEntity.nullable != true> NOT NULL</#if><#if columnEntity.autoIncrement == true> AUTO_INCREMENT</#if><#if columnEntity.indexType?? && columnEntity.indexType == "PRIMARY"> PRIMARY KEY</#if> COMMENT '${columnEntity.caption}'
...
<#elseif columnEntity.dataType == "CHAR">
  `${columnEntity.name}` CHAR(${columnEntity.length})<#if columnEntity.defaultValue??> DEFAULT '${columnEntity.defaultValue}'</#if><#if columnEntity.nullable != true> NOT NULL</#if><#if columnEntity.indexType?? && columnEntity.indexType == "PRIMARY"> PRIMARY KEY</#if> COMMENT '${columnEntity.caption}'
<#elseif columnEntity.dataType == "VARCHAR">
  `${columnEntity.name}` VARCHAR(${columnEntity.length})<#if columnEntity.defaultValue??> DEFAULT '${columnEntity.defaultValue}'</#if><#if columnEntity.nullable != true> NOT NULL</#if><#if columnEntity.indexType?? && columnEntity.indexType == "PRIMARY"> PRIMARY KEY</#if> COMMENT '${columnEntity.caption}'
...
<#else>
  `${columnEntity.name}` VARCHAR(200)<#if columnEntity.defaultValue??> DEFAULT ${columnEntity.defaultValue}</#if><#if columnEntity.nullable != true> NOT NULL</#if><#if columnEntity.indexType?? && columnEntity.indexType == "PRIMARY"> PRIMARY KEY</#if> COMMENT '${columnEntity.caption}'
</#if>
