...
sed -i "s/spring.datasource.hikari.data-sources.*.mysql.password=.*$/spring.datasource.hikari.data-sources[0].mysql.password=$CRUDAPI_MYSQL_PASSWORD/g" application-prod.properties
